...
in all web browsers. Service worker registration [won't be attempted](src/js/services/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src/js/services/registerServiceWorker.js), which
